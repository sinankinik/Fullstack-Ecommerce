...
const Info = ({ singleProduct }) => {
    ...
    const discountedPrice = singleProduct.price.current - (singleProduct.price.current * singleProduct.price.discount) / 100;
                    ...
                    <div className="colors">
                        ...
                        <div className='colors-wrapper'>
                            {singleProduct.colors.map((color, index) => (
                                <div className="colors-wrapper active" key={index}>
